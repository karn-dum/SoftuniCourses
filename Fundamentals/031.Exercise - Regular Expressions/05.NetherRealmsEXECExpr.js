function solve(inp) {
    ...
    while ( inp.length > 0 ) {
        ...
        let numbers;
        while ( (numbers = pattern_2.exec(demonsName) ) !== null ) {
            let lastMatch = pattern_2.lastIndex;

            console.log(numbers.groups.digits, ':', numbers.groups.signs);
            
            if( pattern_2.lastIndex == lastMatch ) pattern_2.lastIndex++;
        }
        return;
